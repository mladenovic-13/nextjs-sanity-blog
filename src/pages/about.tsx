...
const AboutMe: NextPageWithLayout = () => {
  return (
    <>
      <Head>
        <title>Mladenovic13 - About Me</title>
        <meta
          name="description"
          content="Over time I realized that university courses aren&#39;t enough
                and I started digging deeper into the digital world. I was
                fascinated by Digital Marketing, some e-commerce business
                models, content writing et cetera, but I always went back to my
                first love, coding."
        />
      </Head>
      <div className=" flex flex-col items-center gap-20 lg:gap-28  py-4 lg:py-16 bg-slate-900 pb-12 min-h-screen justify-center">
          ...
          <div className="flex gap-10 w-full">
            <div className="w-1/2 flex gap-10 flex-col justify-center items-center">
              <div>
                ...
                <h2 className="  text-slate-500 font-light">
                  Nikola Mladenovic
                </h2>
              </div>
            ...
            <div className="w-1/2 flex flex-col gap-10">
              ...
              <p className="indent-6 text-lg">
                Over time I realized that university courses aren&#39;t enough
                and I started digging deeper into the digital world. I was
                fascinated by Digital Marketing, some e-commerce business
                models, content writing et cetera, but I always went back to my
                first love, coding.
        ...
        <div className="lg:hidden w-5/6 flex justify-center gap-5 flex-col items-center ">
          ...
          <p className="indent-6 font-light">
            ...
            program in C and manipulated it to produce a desirable output, I
            have been obsessed with the idea of using software to solve
            real-world problems. This is one of many reasons I decided to study
            Computer Science at Belgrade University.
          </p>
          <p className="indent-6 font-light">
            Over time I realized that university courses aren&apos;t enough, and
            I started digging deeper into the digital world. I was fascinated by
